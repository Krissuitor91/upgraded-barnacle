...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if so remove the bullet and the alien and update the score."""
        ...
        """When fleet is destroyed, destroy any bullets and spawn a new fleet."""
        if not self.aliens:
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        """Determine number of rows fit on the screen."""
    ...
    def _create_alien(self, alien_number, row_number):
        """Create an alien and place it it the row."""
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
    ...
    def _update_aliens(self):
        """Check if the fleet hits an edge then update all positions."""
